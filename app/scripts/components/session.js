    ...
    var displayErrors = () => {
      ...
      return (
        <div className="session-message-error">
          <B.Grid>
          <div className="session-message-error-text">
            <B.Row>
              <B.Col md={8} lg={8} mdOffset={2} lgOffset={2}>
              Sorry! Something bad happened and we've let people know about it.
              </B.Col>
              <B.Col md={1} lg={1} mdOffset={1} lgOffset={1}>
              <B.Button bsStyle='danger' onClick={this._dismissError.bind(this)}>Dismiss</B.Button>
              </B.Col>
            </B.Row>
          </div>
          </B.Grid>
